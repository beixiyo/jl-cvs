import { debounce, getWinHeight, getWinWidth } from '@jl-org/tool'
...
export class Grid {
  ...
  constructor(canvas: HTMLCanvasElement, options: GridOptions = {}) {
    ...
    this.debounceTime = options.debounceTime || 80
    this.onResizeDebounce = debounce(this._onResize.bind(this), this.debounceTime)

    this.cellWidth = options.cellWidth || 25
    this.cellHeight = options.cellHeight || 25
    ...
    this.highlightBorderWidth = options.highlightBorderWidth || 1
