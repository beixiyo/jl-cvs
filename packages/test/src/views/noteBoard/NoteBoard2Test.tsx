...
import { useNoteBoard2 } from './hooks/useNoteBoard2'

export default function NoteBoard2Test() {
  const [showShortcutModal, setShowShortcutModal] = useState(false)
  const [infiniteCanvasEnabled, setInfiniteCanvasEnabled] = useState(true)
  ...
  /** 切换无限画布模式 */
  const handleToggleInfiniteCanvas = () => {
    const newEnabled = !infiniteCanvasEnabled
    setInfiniteCanvasEnabled(newEnabled)
    actions.setInfiniteCanvasEnabled(newEnabled)
  }
    ...
    <div className="min-h-screen from-slate-50 via-blue-50 to-indigo-100 bg-gradient-to-br dark:from-gray-900 dark:via-slate-900 dark:to-indigo-950">
      ...
      <div className="relative z-10 p-6 space-y-8">
        <div className="text-center">
          <h1 className="mb-4 text-3xl text-gray-900 font-bold dark:text-white">
            🚀 NoteBoard2 无限画布测试
          </h1>
          <p className="mx-auto max-w-3xl text-lg text-gray-600 leading-relaxed dark:text-gray-300">
            基于 Canvas API 的真正无限画布，支持鼠标中心缩放、无限平移等功能
          </p>
        </div>
        ...
        <div className="border border-gray-200/50 rounded-xl bg-white/80 p-6 shadow-lg backdrop-blur-sm dark:border-gray-700/50 dark:bg-gray-800/80">
          ...
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-4 md:grid-cols-2">
            ...
            <div className="flex items-center space-x-3">
              ...
              <button
                onClick={ handleToggleInfiniteCanvas }
